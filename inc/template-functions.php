 ...
 */
function huis_van_vervoering_print_first_instance_of_block( $block_name, $content = null, $instances = 1 ) {
	$instances_count = 0;
	$blocks_content  = '';
 ...
 */
function huis_van_vervoering_password_form( $post = 0 ) {
	$post   = get_post( $post );
	$label  = 'pwbox-' . ( empty( $post->ID ) ? wp_rand() : $post->ID );
	$output = '<p class="post-password-message">' . esc_html__( 'This content is password protected. Please enter a password to view.', 'huisvanvervoering' ) . '</p>
	<form action="' . esc_url( site_url( 'wp-login.php?action=postpass', 'login_post' ) ) . '" class="post-password-form" method="post">
	<label class="post-password-form__label" for="' . esc_attr( $label ) . '">' . esc_html_x( 'Password', 'Post password form', 'huisvanvervoering' ) . '</label><input class="post-password-form__input" name="post_password" id="' . esc_attr( $label ) . '" type="password" size="20" /><input type="submit" class="post-password-form__submit" name="' . esc_attr_x( 'Submit', 'Post password form', 'huisvanvervoering' ) . '" value="' . esc_attr_x( 'Enter', 'Post password form', 'huisvanvervoering' ) . '" /></form>
	';
	return $output;
}
add_filter( 'the_password_form', 'huis_van_vervoering_password_form' );
 ...
 * @return array
 */
function huis_van_vervoering_get_attachment_image_attributes( $attr, $attachment, $size ) {
...
add_filter( 'wp_get_attachment_image_attributes', 'huis_van_vervoering_get_attachment_image_attributes', 10, 3 );
