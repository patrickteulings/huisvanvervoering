	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-content">
			<figure class="wp-block-image">
				 ...
				 */
				$image_size = apply_filters( 'huis_van_vervoering_attachment_size', 'full' );
		...
		<footer class="entry-footer default-max-width">
			...
			if ( wp_get_post_parent_id( $post ) ) {
				...
				printf(
					...
					esc_html__( 'Published in %s', 'huisvanvervoering' ),
			...
			if ( $metadata ) {
				printf(
					...
					esc_html_x( 'Full size', 'Used before full size attachment link.', 'huisvanvervoering' ), // phpcs:ignore WordPress.Security.EscapeOutput
